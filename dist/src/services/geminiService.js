"use strict";
const { analisarTransacaoComGemini: analisarTransacaoDB, analisarPadroesGastos: analisarPadroesDB, gerarSugestoesEconomia: gerarSugestoesDB, preverGastosFuturos: preverGastosDB, responderPerguntaFinanceira: responderPerguntaDB, testarConexaoGemini: testarConexaoDB } = require('../../geminiService');
