...
async function editarLancamentoCommand(sock, userId, texto) {
    ...
    if (estado?.etapa === 'aguardando_campo_edicao_lancamento') {
        ...
        await (0, stateManager_1.definirEstado)(userId, 'aguardando_valor_edicao_lancamento', {
        ...
        try {
            ...
            await sock.sendMessage(userId, {
                text: `✅ Lançamento editado com sucesso!\n\n` +
                    ...
                    `💰 Valor: R$ ${(0, formatUtils_1.formatarValor)(novosDados.valor)}\n` +
    ...
    const estadoHistorico = await (0, stateManager_1.obterEstado)(userId);
    ...
    msg += `💰 Valor: R$ ${(0, formatUtils_1.formatarValor)(lancamento.valor)}\n`;
    ...
    await (0, stateManager_1.definirEstado)(userId, 'aguardando_campo_edicao_lancamento', {
...
exports.default = editarLancamentoCommand;
//# sourceMappingURL=editarLancamento.js.map