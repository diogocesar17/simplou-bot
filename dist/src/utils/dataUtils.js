...
exports.parseMesAno = parseMesAno;
exports.getNomeMes = getNomeMes;
exports.converterDataParaISO = converterDataParaISO;
...
function parseMesAno(input) {
    ...
    if (match) {
        ...
        if (idx === -1 && nomeMes === 'marco')
            idx = 2;
        if (idx === -1 && nomeMes === 'dezembro')
            idx = 11;
        if (idx !== -1) {
            mes = idx + 1;
...
function converterDataParaISO(dataBR) {
    ...
    if (dataBR.includes('-') && dataBR.length === 10)
        return dataBR;
